...
// ===== SLUG-BASED ROUTES (must be before generic ID routes to avoid conflicts) =====
...
// ===== INTERACTION ROUTES (specific routes before generic ID routes) =====
...
// ===== CRUD ROUTES (generic ID routes - must be last) =====
...
router.get(
  "/donations/:transactionId/status",
  HomeController.getDonationStatus,
);
