...
export class HomeController {
  ...
  static async getTopNews(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success(news, "Berita top berhasil dimuat");
  ...
  static async search(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (!query || typeof query !== "string") {
        return res
          .status(400)
          .json(ApiResponse.error("Search query is required", 400));
      }
      const searchResults = {
        articles: [],
        donations: [],
      ...
      const response = ApiResponse.success(searchResults, "Pencarian berhasil");
  ...
  static async getNavigationMenus(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
  ...
  static async getArticleBySlug(
    ...
    try {
      ...
      if (!article) {
        return res
          .status(404)
          .json(ApiResponse.error("Article not found", 404));
      }

      const response = ApiResponse.success(article, "Artikel berhasil dimuat");
   ...
   */
  static async getDonationBySlug(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
    try {
      ...
      if (!donation) {
        return res
          .status(404)
          .json(ApiResponse.error("Donation not found", 404));
      }

      const response = ApiResponse.success(donation, "Donasi berhasil dimuat");
  ...
  static async getNewsBySlug(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (!news) {
        return res.status(404).json(ApiResponse.error("News not found", 404));
      }

      const response = ApiResponse.success(news, "Berita berhasil dimuat");
  ...
  static async incrementArticleViews(
    ...
    try {
      ...
      const response = ApiResponse.success(result, "Views updated");
  ...
  static async likeArticle(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success(article, "Article liked");
   ...
   */
  static async incrementNewsViews(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
  ...
  static async getRelatedArticles(
    ...
    try {
      ...
      // Use HomeService to get related articles
      const relatedArticles = await HomeService.getRelatedArticles(
   ...
   */
  static async getDonationStatus(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
  ...
  static async trackEvent(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success({ tracked: true }, "Event tracked");
  ...
  static async getPageViews(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success(views, "Page views retrieved");
  ...
  static async getFeedback(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success(feedback, "Feedback retrieved");
  ...
  static async getAllArticles(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      // Use HomeService to get articles
      const result = await HomeService.getAllArticles(page, limit, category);
  ...
  static async getAllDonations(
    ...
    try {
      ...
      // Use HomeService to get donations
      const result = await HomeService.getAllDonations(page, limit, status);
  ...
  static async getAllNews(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      // Use HomeService to get news
      const result = await HomeService.getAllNews(page, limit, category);
  ...
  static async getNewsById(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success(news, "News loaded successfully");
  ...
  static async getVideoById(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = ApiResponse.success(video, "Video loaded successfully");
